...
-- g("flutter_show_log_on_run", "hidden") -- Automatically open __Flutter_Output__ when starting flutter using :FlutterRun; it can have one of the following values:
-- g("flutter_show_log_on_attach", "hidden") -- Identical to g:flutter_show_log_on_run but affecting the :FlutterAttach command.

...
function M.on_attach(client, bufnr)
  ...
  local function nmap(prefix, func)
    vim.keymap.set("n", prefix, function () func() end, opts)
  end
  local function imap(prefix, func)
    vim.keymap.set("i", prefix, function () func() end, opts)
  end
  ...
  nmap("<leader>ca",    function() vim.lsp.buf.code_action()      end)
  ...
  imap("<C-h>", function() vim.lsp.buf.signature_help() end)
end
return M;
